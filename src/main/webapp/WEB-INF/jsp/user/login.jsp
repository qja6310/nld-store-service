...
<script type="text/javascript" src="<%=request.getContextPath() %>/newloading/js/user/login.js?v=001"></script>
	<style type="text/css">
		.a-link{
			font-style: italic;
			margin-top: 10px;
...
<div class="layui-layout layui-layout-admin">
	...
	<div style="width: 20%;margin: 0 auto;text-align: center;margin-top: 80px;">
		...
		<div style="margin: 0 auto;width: 70%;">
			...
			<a class="a-link" style="float: left;" href="<%=request.getContextPath() %>/user/register">没有账号？去注册</a>
		</div>
	</div>
