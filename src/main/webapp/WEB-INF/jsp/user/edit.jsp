...
<div  style="margin: 0 auto;text-align: center;margin-top: 50px;">
	...
	<div style="margin: 0 auto;width: 30%;">
		<button type="button" id="doEditBtn" class="layui-btn layui-btn-fluid" onclick="doEdit()" style="margin-top: 20px;"><i class="layui-icon layui-icon-ok-circle"></i>保存</button>
	</div>
</div>
