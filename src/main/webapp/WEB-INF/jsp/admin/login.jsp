...
<script type="text/javascript" src="<%=request.getContextPath() %>/newloading/js/admin/login.js?v=001"></script>
	<style type="text/css">
		.a-link{
			font-style: italic;
			margin-top: 10px;
	...
	<div>
		<div style="width: 20%;margin: 0 auto;text-align: center;margin-top: 80px;">
				...
				<div style="padding: 20px;margin-left: 25px;">
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="text" id="aAcc" name="aAcc" value="zhangsanfeng.a" autocomplete="off" placeholder="请输入账号" class="layui-input verify">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">密码</label>
						<div class="layui-input-inline">
							<input type="password" id="aPwd" name="aPwd" value="123456" autocomplete="off" placeholder="请输入密码" class="layui-input verify">
						</div>
					</div>
				</div>
			</form>
			<div style="margin: 0 auto;width: 70%;">
				...
				<a class="a-link" style="float: left;" href="<%=request.getContextPath() %>/merchant/register"></a>
				<a class="a-link" style="float: right;color: orangered;" >建议使用Google浏览器</a>
			</div>
		</div>
	</div>
